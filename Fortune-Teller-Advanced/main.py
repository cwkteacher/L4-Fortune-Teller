...
fortunes = ['You will be very successful this year.','Next year will bring great things.',
            'You will come into a large fortune.', 'This will be a very bad year for you.',
            'You will not be successful this year.','You will lose something very dear to you this year.']
...
def generate_fortune(month, letter,age):
    fortune_idx = ((months.index(month)+ord(letter)+age)*random.randint(1,2))%len(fortunes)
...
def main():
    ...
    while answer.lower() != 'no':
        if answer.lower() == 'yes':
            ...
            answer = input('Sorry I do not understand {}.\nPlease enter "yes" or "no".\n'.format(answer))
